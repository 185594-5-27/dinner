package com.dinner.snqjf.common.util.json;
...
public class JsonHelper {
    ...
    public static void main(String [] args){
        String a = "[{\"0\":true,\"sort\":null,\"order\":\"\",\"limit\":0,\"page\":0,\"offset\":0,\"id\":4,\"type\":null,\"code\":null,\"text\":null,\"value\":null}]";
        List<Dict> dict = (List<Dict>)toList(a,Dict.class);
        for(Dict d:dict){
